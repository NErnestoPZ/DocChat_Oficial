        ...
        return snapshot.hasData
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return MessageTile(
                    message: snapshot.data.documents[index].data["Mensaje"],
                    sendByMe: Constants.myName ==
                        snapshot.data.documents[index].data["Enviado"],
                  );
                })
            : Container();
      },
  ...
  addMessage() {
    if (messageEditingController.text.isNotEmpty) {
      Map<String, dynamic> chatMessageMap = {
        "Enviado por": Constants.myName,
        "Mensaje": messageEditingController.text,
